...
{
    Uint16 CLKPRESCALE;
    Uint16 cmpssBaseAddr, OutputXbarBaseAddr;
    u4  u4_cmpNum;
    Uint16 cast;
    ...
    OutputXbarBaseAddr = (Uint16)&OutputXbarRegs;
    ...
    HWREGH(cmpssBaseAddr + CMPSS_O_COMPCTL) |= (Uint16)((CTRIPLSEL << CMPSS_COMPCTL_CTRIPOUTHSEL_S) & CMPSS_COMPCTL_CTRIPOUTHSEL_M);
    HWREGH(cmpssBaseAddr + CMPSS_O_COMPCTL) |= (Uint16)((CTRIPHSEL << CMPSS_COMPCTL_CTRIPOUTLSEL_S) & CMPSS_COMPCTL_CTRIPOUTLSEL_M);
    ...
    HWREG(OutputXbarBaseAddr + 0x28) |= (Uint32)(0x3 << (2*(u4_cmpNum-1)));
    EDIS;
}
