...
void pwmProtectionInit(){
    ...
    f4_Temperature_1 = 80.0;
    f4_Temperature_2 = 80.0;
    f4_Temperature_3 = 80.0;
    f4_Temperature_4 = 80.0;
    f4_Temperature_i = 80.0;

    //(CT1)
    N_ConfigCmpss (1 ,1.0e-6 );              // Hardware protection setup
    N_HardCmpHigh (1, f4g_gainI1,  10.0 );
    N_HardCmpLow  (1, f4g_gainI1, -10.0);
    N_CMP_CLEAR   (1);

    //(CT2)
    N_ConfigCmpss (2 ,1.0e-6 );              // Hardware protection setup
    N_HardCmpHigh (2, f4g_gainI2,  10.0);
    N_HardCmpLow  (2, f4g_gainI2, -10.0);
    N_CMP_CLEAR   (2);

    //(CT3)
    N_ConfigCmpss (3 ,1.0e-6 );              // Hardware protection setup
    N_HardCmpHigh (3, f4g_gainI3,  10.0);
    N_HardCmpLow  (3, f4g_gainI3, -10.0);
    N_CMP_CLEAR   (3);

    //(CT4)
    N_ConfigCmpss (4 ,1.0e-6 );              // Hardware protection setup
    N_HardCmpHigh (4, f4g_gainI4, 10.0);
    N_HardCmpLow  (4, f4g_gainI4,-10.0);
    N_CMP_CLEAR   (4);

    //(CT5)
    N_ConfigCmpss (5 ,1.0e-6 );              // Hardware protection setup
    N_HardCmpHigh (5, f4g_gainI5, 10.0);
    N_HardCmpLow  (5, f4g_gainI5,-10.0);
    N_CMP_CLEAR   (5);

    //(CT6)
    N_ConfigCmpss (6 ,1.0e-6 );              // Hardware protection setup
    N_HardCmpHigh (6, f4g_gainI6, 10.0);
    N_HardCmpLow  (6, f4g_gainI6,-10.0);
    N_CMP_CLEAR   (6);

    XBAR_clearOutputLatch(XBAR_OUTPUT5);
}
